       ...
       <div class="md:hidden flex flex-col h-full">
        <div class="relative">
         ...
         <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
          <img src="{{ asset('promo-sociolla.jpg') }}" alt="Sociolla" class="w-full h-full object-cover" loading="lazy">
         </div>
        </div>
       ...
       <div class="hidden md:block">
        <div class="grid grid-cols-2 gap-0">
         <div class="card-content p-4 flex flex-col">
          <div class="mb-1">
           <img src="{{ asset('sociolla.png') }}" alt="SOCIOLLA" class="card-logo w-[180px] h-[82px] object-contain" loading="lazy">
          </div>
          ...
          <div class="card-description mt-1 md:mt-2 text-[11px] md:text-xs text-neutral-800 font-medium">Voucher Sociolla Rp 100,000</div>
         ...
         <div class="card-image-wrapper p-2">
          <div class="aspect-[6/3] md:h-full rounded-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
           <img src="{{ asset('promo-sociolla.jpg') }}" alt="" class="w-full h-full object-cover" loading="lazy">
          </div>
         </div>
        </div>
       </div>
      ...
      <article onclick="window.open('https://instagram.com', '_blank')" class="group overflow-hidden rounded-xl md:rounded-2xl border border-neutral-200 bg-white shadow-md transition-all hover:shadow-xl hover:scale-[1.01] hover:border-rose-200 cursor-pointer opacity-0 translate-y-2 transition-all duration-200 ease-out h-full min-h-[280px]" style="animation-delay: 0.08s">
       ...
       <div class="md:hidden flex flex-col h-full">
        <div class="relative">
         ...
         <!-- Promo Image -->
         <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
          <img src="{{ asset('promo-guardian.jpg') }}" alt="Guardian" class="w-full h-full object-cover" loading="lazy">
         </div>
        </div>
       ...
       <div class="hidden md:block">
        <div class="grid grid-cols-2 gap-0">
         <div class="card-content p-4 flex flex-col">
          <div class="mb-1">
           <img src="{{ asset('guardian.png') }}" alt="GUARDIAN" class="card-logo w-[180px] h-[82px] object-contain" loading="lazy">
          </div>
          <div class="pl-10 md:pl-14">
           <div class="card-title text-rose-600 font-bold text-base md:text-3xl mb-0.5">Voucher</div>
          ...
          <div class="card-description mt-1 md:mt-2 text-[11px] md:text-xs text-neutral-800 font-medium">Voucher Guardian Rp 50,000</div>
          <div class="card-points mt-1 md:mt-2 inline-flex items-center gap-1.5 text-[11px] md:text-xs font-semibold text-orange-600">
           <span class="inline-flex h-5 w-5 md:h-6 md:w-6 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-orange-500 text-white text-[10px] md:text-xs font-bold shadow-sm">P</span>
         ...
         <div class="card-image-wrapper p-2">
          <div class="aspect-[6/3] md:h-full rounded-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
           <img src="{{ asset('promo-guardian.jpg') }}" alt="" class="w-full h-full object-cover" loading="lazy">
          </div>
         </div>
        </div>
       </div>
      ...
      <article id="extraBeautyCard" onclick="window.open('https://instagram.com', '_blank')" class="mt-2 group overflow-hidden rounded-xl md:rounded-2xl border border-neutral-200 bg-white shadow-md transition-all duration-500 ease-in-out hover:shadow-xl hover:scale-[1.01] hover:border-purple-200 max-h-0 opacity-0 scale-y-0 origin-top cursor-pointer h-full">
       ...
       <div class="md:hidden flex flex-col h-full">
        <div class="relative">
         ...
         <!-- Promo Image -->
         <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
          <img src="{{ asset('promo-watsons.jpg') }}" alt="Watsons" class="w-full h-full object-cover" loading="lazy">
         </div>
        </div>
       ...
       <div class="hidden md:block">
        <div class="grid grid-cols-2 gap-0">
         <div class="card-content p-4 flex flex-col">
          <div class="mb-1">
           <img src="{{ asset('watsons.png') }}" alt="WATSONS" class="card-logo w-[180px] h-[82px] object-contain" loading="lazy">
          </div>
          <div class="pl-10 md:pl-14">
           <div class="card-title text-rose-600 font-bold text-base md:text-3xl mb-0.5">Voucher</div>
           <div class="card-price text-rose-600 font-bold text-xl md:text-2xl leading-none mb-2">Rp75<span class="text-xl md:text-2xl">ribu</span></div>
          </div>
          <div class="card-description mt-1 md:mt-2 text-[11px] md:text-xs text-neutral-800 font-medium">Voucher Watsons Rp 75,000</div>
          <div class="card-points mt-1 md:mt-2 inline-flex items-center gap-1.5 text-[11px] md:text-xs font-semibold text-orange-600">
           <span class="inline-flex h-5 w-5 md:h-6 md:w-6 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-orange-500 text-white text-[10px] md:text-xs font-bold shadow-sm">P</span>
         ...
         <div class="card-image-wrapper p-2">
          <div class="aspect-[6/3] md:h-full rounded-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
           <img src="{{ asset('promo-watsons.jpg') }}" alt="" class="w-full h-full object-cover" loading="lazy">
          </div>
         </div>
        </div>
       </div>
