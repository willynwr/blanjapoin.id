   <section id="section-food" class="mt-10 md:mt-14">
     ...
     <div id="foodCardContainer" class="card-container grid grid-cols-2 gap-3 md:grid-cols-1 md:gap-5 items-stretch">
       ...
       <div class="md:hidden flex flex-col h-full">
        <div class="relative">
         ...
         <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
          <img src="{{ asset('promo-wingstop.jpg') }}" alt="Wingstop" class="w-full h-full object-cover" loading="lazy">
         </div>
        </div>
       ...
       <div class="hidden md:block">
        <div class="grid grid-cols-2 gap-0">
         <div class="card-content p-4 flex flex-col">
          <div class="mb-1">
           <img src="{{ asset('coba.png') }}" alt="WINGSTOP" class="card-logo w-[180px] h-[82px] object-contain" loading="lazy">
          </div>
      ...
      <article onclick="window.open('https://instagram.com', '_blank')" class="group overflow-hidden rounded-xl md:rounded-2xl border border-neutral-200 bg-white shadow-md transition-all hover:shadow-xl hover:scale-[1.01] hover:border-red-200 cursor-pointer opacity-0 translate-y-2 transition-all duration-200 ease-out h-full min-h-[280px]" style="animation-delay: 0.08s">
       ...
       <div class="md:hidden flex flex-col h-full">
        <div class="relative">
         ...
         <!-- Promo Image -->
         <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
          <img src="{{ asset('promo-pizzahut.png') }}" alt="Pizza Hut" class="w-full h-full object-cover" loading="lazy">
         </div>
        </div>
       ...
       <div class="hidden md:block">
        <div class="grid grid-cols-2 gap-0">
         <div class="card-content p-4 flex flex-col">
          <div class="mb-1">
           <img src="{{ asset('pizzahut.png') }}" alt="PIZZA HUT" class="card-logo w-[180px] h-[82px] object-contain" loading="lazy">
          </div>
          <div class="pl-10 md:pl-14">
           <div class="card-title text-rose-600 font-bold text-base md:text-3xl mb-0.5">Diskon</div>
         ...
         <div class="card-image-wrapper p-2">
          <div class="aspect-[6/3] md:h-full rounded-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
           <img src="{{ asset('promo-pizzahut.png') }}" alt="" class="w-full h-full object-cover" loading="lazy">
          </div>
         </div>
        </div>
       </div>
      ...
      <article id="extraFoodCard" onclick="window.open('https://instagram.com', '_blank')" class="mt-2group overflow-hidden rounded-xl md:rounded-2xl border border-neutral-200 bg-white shadow-md transition-all duration-500 ease-in-out hover:shadow-xl hover:scale-[1.01] hover:border-yellow-200 max-h-0 opacity-0 scale-y-0 origin-top cursor-pointer h-full">
       ...
       <div class="md:hidden flex flex-col h-full">
        <div class="relative">
         ...
         <!-- Promo Image -->
         <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
          <img src="{{ asset('promo-kfc.jpg') }}" alt="KFC" class="w-full h-full object-cover" loading="lazy">
         </div>
        </div>
       ...
       <div class="hidden md:block">
        <div class="grid grid-cols-2 gap-0">
         <div class="card-content p-4 flex flex-col">
          <div class="mb-1">
           <img src="{{ asset('kfc.png') }}" alt="KFC" class="card-logo w-[180px] h-[82px] object-contain" loading="lazy">
          </div>
          <div class="pl-10 md:pl-14">
           <div class="card-title text-rose-600 font-bold text-base md:text-3xl mb-0.5">Diskon</div>
         ...
         <div class="card-image-wrapper p-2">
          <div class="aspect-[6/3] md:h-full rounded-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
           <img src="{{ asset('promo-kfc.jpg') }}" alt="" class="w-full h-full object-cover" loading="lazy">
          </div>
         </div>
        </div>
       </div>
