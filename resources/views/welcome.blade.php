 ...
 <body class="bg-white text-neutral-900 antialiased font-poppins min-h-screen">
  ...
  <div class="mx-auto max-w-[1120px]">
   <main class="px-4 md:px-7 lg:px-8 pb-12 md:pb-16">
    ...
    <div id="telkomselCardContainer" class="card-container grid grid-cols-2 gap-3 md:grid-cols-1 md:gap-5">
     <article class="group overflow-hidden rounded-xl md:rounded-2xl border border-neutral-200 bg-white shadow-md transition-all hover:shadow-xl hover:scale-[1.01] hover:border-red-200">
      <!-- Mobile Layout (default) -->
      <div class="md:hidden flex flex-col h-full">
       <div class="relative">
        ...
        <!-- Promo Image -->
        <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden"> 
         <img src="{{ asset('promo-telkomsel.jpg') }}" alt="Telkomsel 10GB" class="w-full h-full object-cover">
        </div>
       </div>
       <!-- Card Content Below Image -->
       <div class="flex flex-col p-3 space-y-2">
     ...
     <article id="extraTelkomselCard" class="group overflow-hidden rounded-xl md:rounded-2xl border border-neutral-200 bg-white shadow-md transition-all duration-500 ease-in-out hover:shadow-xl hover:scale-[1.01] hover:border-red-200 max-h-0 opacity-0 scale-y-0 origin-top">
      ...
      <div class="md:hidden flex flex-col h-full">
       <div class="relative">
        ...
        <div class="absolute top-2 right-2 z-10 flex items-end gap-5">
         <div class="inline-flex items-center gap-1 bg-white/70 rounded-full px-2 py-1">
          <span class="text-xs">🔥</span>
          <span class="text-[10px] font-semibold text-orange-600">150000 Poin</span>
         </div>
        </div>
        <!-- Promo Image -->
        <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
       ...
       <div class="flex-1 flex flex-col justify-between">
        <div class="pb-0.5 px-1.5">
         <div class="text-center">
          <p class=" mt-2 text-left text-xs font-bold text-base leading-tight whitespace-normal">
           Paket Data 50GB<br>
           <span class="font-light">Paket Data Telkomsel 50GB masa aktif 30 hari</span>
          </p>
         </div>
        </div>
        <!-- Mobile Footer -->
        <div class="px-2 py-1 bg-neutral-50 text-[10px] text-neutral-600">
         <div class="flex justify-between items-center">
          <p class="font-medium">Remaining Stock • 200<br>
           <span class="font-medium">Valid until • 31 Dec 2025</span>
          </p>
         </div>
        </div>
     ...
     <div class="grid grid-cols-2 gap-3 md:grid-cols-1 md:gap-5">
      ...
      <div class="md:hidden flex flex-col h-full">
       <div class="relative">
        ...
        <!-- Promo Image -->
        <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
         <img src="{{ asset('promo-cgv.jpg') }}" alt="CGV Cinema" class="w-full h-full object-cover">
        </div>
       </div>
       <!-- Card Content Below Image -->
       <div class="flex flex-col p-3 space-y-2">
      ...
      <div class="md:hidden flex flex-col h-full">
       <div class="relative">
        ...
        <!-- Promo Image -->
        <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
         <img src="{{ asset('promo-spotify.jpg') }}" alt="Spotify Premium" class="w-full h-full object-cover">
        </div>
       </div>
       <!-- Card Content Below Image -->
       <div class="flex flex-col p-3 space-y-2">
      ...
      <div class="md:hidden flex flex-col h-full">
       <div class="relative">
        ...
        <!-- Promo Image -->
        <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
         <img src="{{ asset('promo-netflix.jpg') }}" alt="Netflix Premium" class="w-full h-full object-cover">
        </div>
       </div>
       <!-- Card Content Below Image -->
       <div class="flex flex-col p-3 space-y-2">
     ...
     <div class="grid grid-cols-2 gap-3 md:grid-cols-1 md:gap-5">
      ...
      <div class="md:hidden flex flex-col h-full">
       <div class="relative">
        ...
        <!-- Promo Image -->
        <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
         <img src="{{ asset('promo-sociolla.jpg') }}" alt="Sociolla" class="w-full h-full object-cover">
        </div>
       </div>
       <!-- Card Content Below Image -->
       <div class="flex flex-col p-3 space-y-2">
      ...
      <div class="md:hidden flex flex-col h-full">
       <div class="relative">
        ...
        <!-- Promo Image -->
        <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
         <img src="{{ asset('promo-guardian.jpg') }}" alt="Guardian" class="w-full h-full object-cover">
        </div>
       </div>
       <!-- Card Content Below Image -->
       <div class="flex flex-col p-3 space-y-2">
      ...
      <div class="md:hidden flex flex-col h-full">
       <div class="relative">
        ...
        <!-- Promo Image -->
        <div class="aspect-[4/3] rounded-t-xl bg-gradient-to-br from-neutral-100 to-neutral-200 shadow-inner overflow-hidden">
         <img src="{{ asset('promo-watsons.jpg') }}" alt="Watsons" class="w-full h-full object-cover">
        </div>
       </div>
       <!-- Card Content Below Image -->
       <div class="flex flex-col p-3 space-y-2">
